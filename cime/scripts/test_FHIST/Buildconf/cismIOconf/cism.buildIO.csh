...
# -----------------------------------------------------------------------------
# NOTICE: This script was custom-generated for /network/rit/lab/schiraldilab/repos/my_cesm_sandbox/cime/scripts/test_FHIST.
#
#         DO NOT COPY to another case!
#
#         Use this script ONLY in /network/rit/lab/schiraldilab/repos/my_cesm_sandbox/cime/scripts/test_FHIST.
# -----------------------------------------------------------------------------

set sourcemod_dir  = /network/rit/lab/schiraldilab/repos/my_cesm_sandbox/cime/scripts/test_FHIST/SourceMods/src.cism/source_cism
set cism_confIOdir = /network/rit/lab/schiraldilab/repos/my_cesm_sandbox/cime/scripts/test_FHIST/Buildconf/cismIOconf
